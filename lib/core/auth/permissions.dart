...
enum Permission {
  ...
  priceOverride('price_override', 'Price override', 'Change the price of a line on the order'),
  itemAvailability('item_availability', 'Item availability',
      'Mark an item sold out, or pin it as a favourite'),
  assignTables('assign_tables', 'Assign tables',
      'Share the room out between the waiters on shift'),
  openAnyTable('open_any_table', 'Open any table',
      'Open a table that is assigned to another waiter'),
