...
/// Where a cashier lands after signing in.
///
/// The floor is opened from the shell, which sits above the navigator it builds, so
/// it has to push through the navigator's own key. It did not for a while: every
/// sign-in on an empty till threw and quietly stayed on the sell screen, and no test
/// noticed because the other app tests all restore a draft order, which is the one
/// case that deliberately skips the floor.
void main() {
  late Db db;
