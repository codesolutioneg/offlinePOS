...
void main() {
  ...
  test('a 25% order discount books the reduced total in Odoo', () async {
    ...
    final booked = ((await wiring.catalogueCall('pos.order', 'search_read',
        [[['uuid', '=', order.uuid]], ['amount_total', 'amount_tax']], {})) as List).first as Map;
    print('ODOO amount_total=${booked['amount_total']}');
    // Discount is folded into line unit prices on the till; pos.order amount_total
    // is the gross the module recomputed from lines.
