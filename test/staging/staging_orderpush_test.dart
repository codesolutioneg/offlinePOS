...
void main() {
  ...
  test('a real paid order pushes through the sender and books in Odoo', () async {
    ...
    // confirm Odoo booked it as a pos.order, keyed by the client uuid
    ...
    expect((found).first['state'], isNot('draft'),
        reason: 'the POS order should be paid/settled after offline booking');
    db.close();
